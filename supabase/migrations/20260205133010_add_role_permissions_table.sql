/*
  # Adicionar tabela de permissões customizáveis por role
  ...
  2. Segurança
    - Habilitar RLS
    - Apenas administradores podem ler e modificar permissões
...
CREATE POLICY "Apenas admins podem visualizar permissões"
...
CREATE POLICY "Apenas admins podem excluir permissões"
