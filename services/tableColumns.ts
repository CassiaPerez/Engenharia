export const TABLE_COLUMNS = {
  ...
  projects: 'id, code, description, detailed_description, category, status, reason_type, reason, responsible, cost_center, location, area, city, start_date, estimated_end_date, estimated_value, sla_days, manual_material_cost, manual_service_cost, created_at, updated_at',
